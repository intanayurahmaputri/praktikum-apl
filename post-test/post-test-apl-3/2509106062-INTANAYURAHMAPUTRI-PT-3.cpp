...
void bayarPesanan(Pesanan dataPesanan[], Produk dataProduk[], int &jumlahPesanan) {
    if (jumlahPesanan == 0) {
        cout << "=== RINCIAN PESANAN ^3^ ===\n";
        cout << "Belum ada pesanan.\n";
    } else {
        cout << "===========================================================\n";
        cout << "No  Produk                         Jumlah        Subtotal\n";
        cout << "===========================================================\n";
        ...
        for (int i = 0; i < jumlahPesanan; i++) {
            ...
            cout << i + 1 << "   ";
            cout << dataProduk[idx].name;

            int spasi = 30 - dataProduk[idx].name.length();
            for (int j = 0; j < spasi; j++) cout << " ";

            cout << jml << "             ";
            cout << "Rp" << harga * jml << endl;
        }
        ...
        cout << "Total + Pajak 5% : Rp" << totalPajak << endl;

        string konfirmasi;
        cout << "\nTotal bayar: Rp" << totalPajak << endl;

...
void sortNamaDesc(Produk dataProduk[], int jumlahProduk) { //bubble sort
    ...
    cout << "Produk berhasil diurutkan (Nama Z-A).\n\n";
}
...
void sortHargaAsc(Produk dataProduk[], int jumlahProduk) { //selection sort
    ...
    cout << "Produk berhasil diurutkan (Harga termurah).\n\n";
}
...
void sortStokDesc(Produk dataProduk[], int jumlahProduk) { //insertion sort
    ...
    cout << "Produk berhasil diurutkan (Stok terbanyak).\n\n";
}
            ...
            if (loginAdmin) {
                do {
                    ...
                    if (pilihan == "1") {
                        ...
                        cout << "--------------------------\n";
                        cout << "Pilih: "; cin >> pilihCari;

                        if (pilihCari == "1") {
                            int harga;
                            cout << "\nMasukkan harga yang dicari: "; cin >> harga;
                            int hasil = sequentialSearchHarga(dataProduk, jumlahProduk, harga);

                            if (hasil != -1) {
                                cout << "\nProduk ditemukan:\n";
                                cout << dataProduk[hasil].name << " | " << dataProduk[hasil].kategori << " | " << dataProduk[hasil].detail.harga << endl;
                            } else {
                                cout << "[!] Produk tidak ditemukan.\n";
                            }
                        } else if (pilihCari == "2") {
                            string nama;
                            cout << "\nMasukkan nama produk: "; cin.ignore(); getline(cin, nama);
